 ...
 * 
 * <p>
 * Fetches "beanmapping.xsd" from the classpath resource "/beanmapping.xsd", no matter if specified as some local URL or
 * as "http://dozer.sourceforge.net/schema/beanmapping.xsd".
 * 
...
public class DozerResolver implements EntityResolver {
    ...
    public InputSource resolveEntity(String publicId, String systemId) {
        ...
        if (systemId != null && !"".equals(systemId)) {
            ...
            try {
                InputStream inputStream = DozerResolver.class.getResourceAsStream(sytemIdStripped);
                if (inputStream != null) {
